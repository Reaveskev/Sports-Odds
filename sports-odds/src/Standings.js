    ...
    <div className={styles.standing_div}>
      ...
      <div className={styles.standingsContainer}>
        {standings?.map((conference, i) => (
          <div key={i} className={styles.conferenceCard}>
            <h2 className={styles.conferenceTitle}>{conference.conference}</h2>

            {conference.divisions.map((division, j) => (
              <div key={j} className={styles.divisionBlock}>
                <h3 className={styles.divisionTitle}>{division.division}</h3>
                ...
                <div className={styles.teamList}>
                  {division.teams.map((team, k) => (
                    <div className={styles.teamRow} key={k}>
                      <img
